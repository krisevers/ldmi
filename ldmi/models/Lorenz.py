...
class LO(object):
    ...
    def __init__(self, dt, rho, sigma, beta, t_sim, y):
        _Lorenz.LO_swiginit(self, _Lorenz.new_LO(dt, rho, sigma, beta, t_sim, y))

    def derivative(self, y, dydt, t):
        return _Lorenz.LO_derivative(self, y, dydt, t)

    def integrate(self, method):
        return _Lorenz.LO_integrate(self, method)

    def eulerIntegrate(self):
        return _Lorenz.LO_eulerIntegrate(self)

    def euler(self, y, t):
        return _Lorenz.LO_euler(self, y, t)

    def rk4Integrate(self):
        return _Lorenz.LO_rk4Integrate(self)

    def rk4(self, y, t):
        return _Lorenz.LO_rk4(self, y, t)

    def get_states(self):
        return _Lorenz.LO_get_states(self)

    def get_times(self):
        return _Lorenz.LO_get_times(self)
    __swig_destroy__ = _Lorenz.delete_LO

# Register LO in _Lorenz:
_Lorenz.LO_swigregister(LO)

...
SWIGINTERN PyObject *_wrap_new_Sim__SWIG_0(PyObject *SWIGUNUSEDPARM(self), Py_ssize_t nobjs, PyObject **swig_obj) {
  ...
  }
  {
    ...
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), "in method '" "new_Sim" "', argument " "13"" of type '" "dim2""'"); 
    }
    arg13 = *ptr;
    if (SWIG_IsNewObj(res)) delete ptr;
  }
                    ...
                    if (_v) {
                      ...
                      if (_v) {
                        ...
                        if (_v) {
                          ...
                          _v = SWIG_CheckState(res);
                          if (_v) {
                            int res = swig::asptr(argv[12], (std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > >**)(0));
                            _v = SWIG_CheckState(res);
                            if (_v) {
...
fail:
  SWIG_Python_RaiseOrModifyTypeError("Wrong number or type of arguments for overloaded function 'new_Sim'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    Sim::Sim(double,double,double,double,dim1,double,double,double,double,double,double,dim1,dim2,dim1,dim2,double,dim2,bool)\n"
    "    Sim::Sim(double,double,double,double,dim1,double,double,double,double,double,double,dim1,dim2,dim1,dim2,double,dim2)\n");
  return 0;
}
...
SWIGINTERN PyObject *_wrap_Sim_derivative(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_IsOK(ecode4)) {
    SWIG_exception_fail(SWIG_ArgError(ecode4), "in method '" "Sim_derivative" "', argument " "4"" of type '" "size_t""'");
  } 
...
SWIGINTERN PyObject *_wrap_Sim_euler(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  ecode3 = SWIG_AsVal_int(swig_obj[2], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "Sim_euler" "', argument " "3"" of type '" "int""'");
  } 

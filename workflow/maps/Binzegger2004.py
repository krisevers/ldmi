...
num_sources = 10    # L23E L23I L4E L4I L5E L5I L6E L6I CC TH
...
# target: L23E
MAP[:, 0, :] = np.array([   [82.7,	    3471.5,	0.1,	0,	    0,  ],      # L23E
                            [15.8,	    755.6,	0,	    0,	    0,  ],      # L23I
                            [1.5,	    878.9,	0.6,	0,	    0,  ],      # L4E
                            [0,	        44.7,	0.2,	0,	    0,  ],      # L4I
                            [0.9,	    430.1,	0,	    0,	    0,  ],      # L5E
                            [0,	        0,	    0,	    0,	    0,  ],      # L5I
                            [0,	        135,	1.2,	0,	    0,  ],      # L6E
...
# target: L23I
MAP[:, 1, :] = np.array([   [118,	    3162.8,	0.3,	0,	    0,  ],      # L23E
                            [22.5,	    957.9,	0.1,	0,	    0,  ],      # L23I
                            [2.2,	    800.9,	2,	    0,	    0,  ],      # L4E
                            [0.1,	    55.2,	0.6,	0,	    0,  ],      # L4I
                            [1.3,	    391.9,	0.1,	0,	    0,  ],      # L5E
                            [0,	        0,	    0,	    0,	    0,  ],      # L5I
                            [0,	        123,    3.3,	0,	    0,  ],      # L6E
                            [0,	        0,	    0,	    0,	    0,  ],      # L6I
                            [0,         467.68, 0,      0,      9,  ],      # CC
...
MAP[:, 4, :] = np.array([   [370.1,	    1122.1,	34.4,	    4238.1,	5   ],
                            ...
                            [0,	        0,	    0,	        0,	    0   ],
                            [4557.54,   0,      303.34,     780,    0   ],
                            [239.563,   0,      39.424,     3786.5, 0   ]
                            ]).T
...
MAP[:, 6, :] = np.array([   [3.9,	    256.6,	60.3,	620,	218.4   ],
                            ...
                            [0,	        0,	    0,	    0,	    0       ],
                            [48.36,     0,      561.08, 97.902, 4920.538],
                            [2.541,     0,      69.056, 66.15,  309.19  ]
                            ]).T
...
if __name__ == '__main__':
    ...
    sources = ['L23E', 'L23I', 'L4E', 'L4I', 'L5E', 'L5I', 'L6E', 'L6I', 'CC', 'TH']
    targets = ['L23E', 'L23I', 'L4E', 'L4I', 'L5E', 'L5I', 'L6E', 'L6I']

    plt.figure()
    plt.imshow(tot_num_syn, interpolation='nearest', cmap='Reds')
    plt.xticks(np.arange(num_sources), sources, rotation=90)
    plt.yticks(np.arange(num_targets), targets)
    plt.colorbar()

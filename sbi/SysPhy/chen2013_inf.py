...
theta['I_L23E'] = 26.1116 * .5
theta['I_L23I'] = 21.7107 * .5
theta['I_L4E']  = 101.4989 * 1.5
theta['I_L4I']  = 63.9226  * 1.5
theta['I_L5E']  = 52.4852 * .5
theta['I_L5I']  = 51.6137 * .5
theta['I_L6E']  = 83.6562 * 1
theta['I_L6I']  = 32.2155 * 1

E = {'K': 13, 'area': 'V1', 'T': 50, 'onset': 10, 'offset': 20}   # experimental parameters

Psi, X, S, F_l, F_k, B_k, B_v, Y = F(E, theta, mode='full', integrator='numba', verbose=True)  # forward model
